...
--Q.3 Which are the top 5 products with highest average reviwe rating?
...
--Q.7 Segemt customers into New, Returning and Loyal based on number of previous purchases and show the count of each segment.
...
--Q.9 Are Customer who are repeat buyers (more than 5 previous purchase) also likely to subscribe?
select subscription_status,
